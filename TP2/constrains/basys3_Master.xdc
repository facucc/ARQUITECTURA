...
#set_property PACKAGE_PIN W15 [get_ports {entrada[4]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {entrada[4]}]
#set_property PACKAGE_PIN V15 [get_ports {entrada[5]}]					
...
#set_property PACKAGE_PIN W13 [get_ports {entrada[7]}]					
...
##Buttons
#set_property PACKAGE_PIN U18 [get_ports boton1]						
#	set_property IOSTANDARD LVCMOS33 [get_ports boton1]
set_property PACKAGE_PIN T18 [get_ports {reset}]						
	set_property IOSTANDARD LVCMOS33 [get_ports {reset}]
#set_property PACKAGE_PIN W19 [get_ports boton3]						
#	set_property IOSTANDARD LVCMOS33 [get_ports boton3]
